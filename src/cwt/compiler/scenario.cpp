...
scenario::~scenario()
{
  ...
  m_enclosing->emit_tags();
  m_enclosing->emit_bytes(op_code::hook_before, m_enclosing->tags_count());
  ...
  m_enclosing->emit_tags();
  m_enclosing->emit_bytes(op_code::hook_after, m_enclosing->tags_count());
