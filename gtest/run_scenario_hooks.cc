...
class run_scenario_hooks : public ::testing::Test
{
 protected:
  void SetUp() override
  {
    ...
    cuke::registry().push_hook_before(cuke::internal::hook([](){ ++before_calls;}));
    cuke::registry().push_hook_after(cuke::internal::hook([](){ ++after_calls;}));
    cuke::registry().push_hook_before_step(cuke::internal::hook([](){ ++before_step_calls;}));
    cuke::registry().push_hook_after_step(cuke::internal::hook([](){ ++after_step_calls;}));
