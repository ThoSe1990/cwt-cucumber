...
TEST(tag_expression, tags_3_tags_4not_2_brackets)
{
  ...
  compiler::tag_expression tc("not @tag1 or not @tag2 and (not @tag3 or not @tag4)");
...
TEST(tag_expression, tags_3_tags_x_brackets)
{
  ...
  compiler::tag_expression tc("@tag1 or (((@tag2 and @tag3) or (@tag4 and @tag5) or @tag7) and (@tag8 and @tag9))");
...
TEST(tag_expression, tags_3_tags_x_brackets_2)
{
  ...
  compiler::tag_expression tc("@tag1 or (((@tag2 and @tag3) or (@tag4 and @tag5) and @tag7) and (@tag8 and @tag9))");
