...
RUN mkdir -p /root/.conan2/profiles && \
    ...
    echo "build_type=Release" >> /root/.conan2/profiles/clang && \
    ...
    echo "build_type=Release" >> /root/.conan2/profiles/gcc && \
    ...
    cp /root/.conan2/profiles/gcc /root/.conan2/profiles/default
